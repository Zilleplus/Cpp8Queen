...
namespace qn{
    ...
    bool hasVerticalClash(const Queen& q1, const Queen& q2)
    {
        return q1.x == q2.x;
    }
    ...
    int numberOfClashes(const Queen& q1, const Queen& q2)
    {
        ...
        if(hasHorizonalClash(q1,q2)) { numberOfClashes++; }
